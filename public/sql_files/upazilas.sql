...
INSERT INTO `upazilas` (`id`, `zila_id`, `name`, `bn_name`, `url`) VALUES
...
--
ALTER TABLE `upazilas`
  ADD CONSTRAINT `upazilas_ibfk_2` FOREIGN KEY (`zila_id`) REFERENCES `zilas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
